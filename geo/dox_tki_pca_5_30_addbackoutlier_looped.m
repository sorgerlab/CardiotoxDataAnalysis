...
load('allData.mat')
% jointData = [RNASeq dox1 dox2 dox3 dox4 dox5 dox6 dox7];
% 
% 
% 
% jointDataReduced = [jointData(:,2) jointData(:,8) jointData(:,14) jointData(:,20) jointData(:,25:end)];
% % colNames = {'Erl','Lap','Sor','Sun','GSE12260.txt','GSE42177.txt','GSE81448.txt','GSE76314','GSE40289'};
% colNames = {'Erl','Lap','Sor','Sun','GSE12260','GSE42177.txt','GSE81448.txt','GSE40289','GSE64476','GSE97642','GSE37260'};
% 
...
%order of outliers - GSE37260, GSE97642, GSE40289
%New data order to reflect:
jointData = [RNASeq dox1 dox2 dox3 dox5 dox4 dox6]; % dox7];
% jointDataReduced = [jointData(:,2) jointData(:,8) jointData(:,14) jointData(:,20) jointData(:,25:end)];
jointDataReduced = jointData;
% colNames = {'Erl','Lap','Sor','Sun','GSE12260','GSE42177.txt','GSE81448.txt','GSE64476','GSE40289','GSE97642'};%,'GSE37260'};
load('colNames.mat')
colNames(25:end) = {'GSE12260','GSE42177.txt','GSE81448.txt','GSE64476','GSE40289','GSE97642'}; %overwrite generic Dox1, dox2 labels
colNames = colNames(1:end-1);
colNames(25:end) = {'rat','rat','mouse','mouse','mouse'}%,'mouse'};%,'rat'
...
data2 = jointDataReduced(:,1:end-1);
data3 = data2(:,1:end-1);
data4 = data3(:,1:end-1);
dataCell = {jointDataReduced, data2, data3, data4};

col2 = colNames(1:end-1);
col3 = col2(1:end-1);
col4 = col3(1:end-1);
colCell = {colNames, col2, col3, col4};



% 
% tree = linkage(jointDataReduced','average','seuclidean');
% figure;
% dendrogram(tree,'labels',colNames)


for dset = 1%:length(dataCell)
%     clear jointDataReduced
%     clear centeredData
%     clear normData
%     clear normData2
    clearvars -except dataCell colCell dset
    
    jointDataReduced = dataCell{dset};
    colNames = colCell{dset};
...
% tree = linkage(normData','average','correlation');
% figure;
% dendrogram(tree,'labels',colNames)
